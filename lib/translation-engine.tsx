...
export const COMPREHENSIVE_DICTIONARY: Record<string, Record<LanguageCode, string>> = {
  ...
  'Stake Size Bankroll Calculator': { en: 'Stake Size Bankroll Calculator', pidgin: 'Money Management & Bankroll Lab 💰', yoruba: 'Ètò Ìṣirò Owó Eré 💰', igbo: 'Mgbakọ Ego Egwuregwu 💰', hausa: 'Kwamfutar Kula Da Kudi ta Stake Size 💰' },
