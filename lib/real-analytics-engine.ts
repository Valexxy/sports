...
export const AUDITED_PREDICTION_HISTORY: HistoricalPredictionRecord[] = [
  { id: '1', match: 'Arsenal vs Chelsea', pick: 'Over 1.5 Goals', odds: 1.22, stake: 100, result: 'WON', winProb: 91.5 },
  { id: '2', match: 'Real Madrid vs Bayern', pick: '1X Double Chance', odds: 1.18, stake: 100, result: 'WON', winProb: 94.2 },
  { id: '3', match: 'Man City vs Liverpool', pick: 'Over 2.5 Goals', odds: 1.55, stake: 100, result: 'WON', winProb: 88.0 },
  { id: '4', match: 'PSG vs Marseille', pick: 'Home Win', odds: 1.35, stake: 100, result: 'LOST', winProb: 76.0 },
  { id: '5', match: 'Barcelona vs Atletico', pick: 'Over 0.5 Goals', odds: 1.12, stake: 100, result: 'WON', winProb: 96.5 },
