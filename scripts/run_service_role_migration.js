...
const SERVICE_ROLE_KEY = process.argv[2] || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Indwc3BqdHNydnZtbGNlaXpkemNpIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3OTE5MzY2NSwiZXhwIjoyMDk0NzY5NjY1fQ.cn4v-F_ZOenYrLBol3Iza0KiMCvW1MPisv9QVQvGocg';

const sqlQueries = `
-- 1. DROP UNRELATED OLD TABLES
...
-- 2. CREATE THE 6 CORE AURASCORE TABLES
...
async function executeSqlViaApi() {
  const data = JSON.stringify({ query: sqlQueries });
