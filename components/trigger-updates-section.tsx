    ...
    <div className="space-y-3 font-mono text-xs">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-2">
          ...
          <div>
            <h3 className="font-extrabold text-sm text-white">HIGH-TRIGGER REAL MATCH UPDATES</h3>
            <p className="text-[10px] text-gray-400">Live score alerts, settled outcomes, and mathematical banker updates</p>
          </div>
        </div>

        <span className="text-[10px] text-stadiumGreen font-bold px-2 py-1 rounded bg-stadiumGreen/20 border border-stadiumGreen/40">
          REAL FEED ⚡
        </span>
      </div>

      {/* High-Trigger Updates Cards */}
