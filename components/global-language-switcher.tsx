    ...
    <div className="relative font-mono">
      ...
      {open && (
        <>
          ...
          <div className="absolute right-0 mt-2 z-50 w-72 max-h-[440px] overflow-y-auto rounded-3xl glass-panel-premium border-2 border-stadiumGreen shadow-2xl p-2.5 space-y-1 animate-scaleIn font-mono">
